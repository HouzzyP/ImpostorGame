...
export const dictionary = {
    es: {
        ...
        "voting.waiting": "Observando votación...",
        ...
        // Footer
        "footer.credits": "Hecho con 💜 en Argentina",
        ...
        "error.name_long": "El nombre no puede tener más de 15 caracteres",
        "error.name_chars": "El nombre solo puede tener letras, números y espacios",
        "error.code_required": "Ingresa el código de sala",
        "error.code_length": "El código de sala debe tener 4 caracteres",
        "share.text": "¡Jugá conmigo a El Impostor! 🕵️\nCódigo de sala: *{code}*\nEntrá acá:",
        "share.copied": "Invitación copiada al portapapeles",
        "share.copied_code": "Codigo copiado",

        "toast.joined": "¡Te has unido a la partida!",
        "toast.became_host": "Ahora eres el host",
        "toast.category": "Categoría: ",
        ...
        // Footer
        "footer.like": "¿Te gusta El Impostor?",
        ...
        "howto.phase_title": "🗣️ Fase de Descripción",
        ...
        "rules.list_5": "Gana la mayoría o el impostor si sobrevive.",
        "rules.btn_full": "Ver Reglas Detalladas",

        "faq.q1": "¿Los impostores se conocen?",
        "faq.a1": "No, si hay más de uno, no saben quiénes son sus compañeros.",
        "faq.q2": "¿Qué pasa si me desconecto?",
        "faq.a2": "Puedes volver a entrar con el mismo nombre y recuperarás tu rol.",
        "faq.q3": "¿Cómo gano puntos?",
    ...
    en: {
        ...
        // Footer
        "footer.credits": "Made with 💜 in Argentina",
        ...
        "share.text": "Play The Impostor with me! 🕵️\nRoom Code: *{code}*\nJoin here:",
        ...
        "howto.phase_title": "🗣️ Description Phase",
